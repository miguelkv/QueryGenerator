...
public class QEqual implements QPredicate {

	private final QExpression	leftOperator;

	private final QExpression	rightOperator;

	public QEqual( QExpression theLeftOperator, Object theValue ) {
		this( theLeftOperator, QLiteral.of( theValue ) );
	}

	public QEqual( QExpression theLeftOperator, QExpression theRightOperator ) {
