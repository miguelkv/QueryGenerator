...
public class QLessThan implements QPredicate {

	private final QExpression	leftOperator;

	private final QExpression	rightOperator;

	public QLessThan( QExpression theLeftOperator, Object theValue ) {
		this( theLeftOperator, QLiteral.of( theValue ) );
	}

	public QLessThan( QExpression theLeftOperator, QExpression theRightOperator ) {
