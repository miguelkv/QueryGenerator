...
public class TestsEclipseLinkExceptions extends TestExceptions {
	...
	public static void setUpBeforeClass( ) throws Exception {
		...
		TestsEclipseLinkExceptions.em = emf.createEntityManager( );
	}

	@AfterClass
	public static void tearDownAfterClass( ) throws Exception {
		TestsEclipseLinkExceptions.em.close( );
	}

	@Override
	protected EntityManager getEM( ) {
		return TestsEclipseLinkExceptions.em;
	}
